// Mirrored VERBATIM from the website's src/lib/warehouse-requests.ts — the release/confirm transactions.
// It depends only on firebase/firestore, the same package this app uses, so the
