// Shared CRM domain model — mirrored VERBATIM from the website's src/lib/crm.ts.
// It has no imports of any kind, which is what makes copying it whole safe: the
// stages, gates, tracks and value-ladder rules are identical in both apps by
// construction rather than by discipline. Re-copy the file when the website's
// changes; never hand-edit it here.
//
