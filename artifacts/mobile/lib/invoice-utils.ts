// Mirrored VERBATIM from the website's src/utils/invoice-utils.ts. Zero imports.
// VAT and overdue arithmetic must agree exactly across the two apps — a total
// that differs by a rounding rule is a total nobody can reconcile. Re-copy when
// the website's changes; never hand-edit here.
