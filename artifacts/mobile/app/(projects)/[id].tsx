...
const styles = StyleSheet.create({
  ...
  budget: { fontSize: 24, lineHeight: 40, fontFamily: "Inter_600SemiBold", marginBottom: 8 },
  ...
  notice: { alignItems: "center", gap: 8, borderRadius: 12, padding: 8, marginTop: 12 },
  noticeText: { flex: 1, fontSize: 12, lineHeight: 20, fontFamily: "Inter_600SemiBold" },
  hint: { fontSize: 12, lineHeight: 20, fontFamily: "Inter_400Regular", marginTop: 8 },
  emptyLine: { fontSize: 14, lineHeight: 24, fontFamily: "Inter_400Regular", paddingVertical: 4 },
  statRow: { gap: 8, marginBottom: 12 },
  stat: { flex: 1, gap: 4 },
  ...
  boqDesc: { flex: 1, fontSize: 12, lineHeight: 20, fontFamily: "Inter_400Regular" },
  boqQty: { fontSize: 12, lineHeight: 20, fontFamily: "Inter_600SemiBold" },
  tenderRow: { alignItems: "center", gap: 8, minHeight: 44 },
  dot: { width: 8, height: 8, borderRadius: 4 },
  tenderTitle: { flex: 1, fontSize: 14, lineHeight: 24, fontFamily: "Inter_600SemiBold" },
  tenderOffers: { fontSize: 12, lineHeight: 20, fontFamily: "Inter_600SemiBold" },
