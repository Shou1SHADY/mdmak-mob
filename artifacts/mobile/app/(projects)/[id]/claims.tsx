...
const styles = StyleSheet.create({
  ...
  moneyLabel: { flex: 1, fontSize: 12, lineHeight: 20, fontFamily: "Inter_400Regular" },
  moneyValue: { fontSize: 12, lineHeight: 20, fontFamily: "Inter_500Medium", fontVariant: ["tabular-nums"] },
  netRow: { alignItems: "center", justifyContent: "space-between", gap: 10, borderTopWidth: 1, paddingTop: 8, marginTop: 4 },
  netLabel: { flex: 1, fontSize: 14, lineHeight: 24, fontFamily: "Inter_700Bold" },
  netValue: { fontSize: 14, lineHeight: 24, fontFamily: "Inter_700Bold", fontVariant: ["tabular-nums"] },
  by: { fontSize: 12, lineHeight: 20, fontFamily: "Inter_400Regular", marginTop: 2 },
  note: { fontSize: 12, lineHeight: 20, fontFamily: "Inter_400Regular", marginTop: 4 },
  footnote: { fontSize: 12, fontFamily: "Inter_400Regular", lineHeight: 20, paddingVertical: 10 },
});
