...
const styles = StyleSheet.create({
  ...
  title: { flex: 1, fontSize: 15, fontFamily: "Inter_600SemiBold", lineHeight: 24 },
  value: { fontSize: 13, lineHeight: 21, fontFamily: "Inter_600SemiBold" },
  contact: { fontSize: 12, fontFamily: "Inter_400Regular" },
  ...
  stageText: { fontSize: 11, fontFamily: "Inter_500Medium" },
  trackPill: { paddingHorizontal: 8, paddingVertical: 3, borderRadius: 8 },
  trackText: { fontSize: 11, fontFamily: "Inter_400Regular" },
