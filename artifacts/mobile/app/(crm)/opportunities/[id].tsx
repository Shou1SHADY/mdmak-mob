...
const styles = StyleSheet.create({
  ...
  panelHead: { alignItems: "center", justifyContent: "space-between", marginBottom: 10 },
  panelTitle: { fontSize: 15, lineHeight: 24, fontFamily: "Inter_600SemiBold", marginBottom: 10 },
  value: { fontSize: 24, lineHeight: 39, fontFamily: "Inter_600SemiBold", marginBottom: 10 },
  ...
  rail: { gap: 6, marginBottom: 14 },
  railStep: { flex: 1, gap: 6 },
  railBar: { height: 4, borderRadius: 2 },
  railLabel: { fontSize: 10, fontFamily: "Inter_400Regular", textAlign: "center" },
  gateBox: { borderRadius: 12, borderWidth: 1, padding: 12, marginBottom: 12, gap: 4 },
  gateHead: { alignItems: "center", gap: 6, marginBottom: 4 },
  gateTitle: { fontSize: 12, fontFamily: "Inter_600SemiBold", flex: 1 },
  gateItem: { fontSize: 11, fontFamily: "Inter_400Regular" },
  webNote: {
    flexDirection: "row",
    alignItems: "center",
    gap: 8,
  ...
  emptyLine: { fontSize: 13, lineHeight: 21, fontFamily: "Inter_400Regular", paddingVertical: 6 },
  activityRow: { alignItems: "center", gap: 10, minHeight: 40 },
  activityTitle: { flex: 1, fontSize: 13, lineHeight: 21, fontFamily: "Inter_400Regular" },
  historyRow: { alignItems: "center", gap: 10, minHeight: 32 },
  historyDot: { width: 6, height: 6, borderRadius: 3 },
  historyText: { flex: 1, fontSize: 12, fontFamily: "Inter_400Regular" },
  bigLink: {
    alignItems: "center",
    gap: 12,
    borderRadius: 16,
  ...
  bigLinkText: { flex: 1, fontSize: 15, lineHeight: 24, fontFamily: "Inter_600SemiBold" },
});
