...
const styles = StyleSheet.create({
  ...
  identityRow: { alignItems: "center", gap: 12, marginBottom: 14 },
  avatar: { width: 48, height: 48, borderRadius: 14, alignItems: "center", justifyContent: "center" },
  avatarText: { fontSize: 20, lineHeight: 32, fontFamily: "Inter_600SemiBold" },
  identityName: { fontSize: 17, lineHeight: 28, fontFamily: "Inter_600SemiBold" },
  identityMeta: { fontSize: 12, fontFamily: "Inter_400Regular", lineHeight: 18 },
  tierPill: { paddingHorizontal: 10, paddingVertical: 6, borderRadius: 10 },
  tierText: { fontSize: 13, lineHeight: 21, fontFamily: "Inter_600SemiBold" },
  actionRow: { gap: 10 },
  action: {
    flex: 1,
    flexDirection: "row",
  ...
  dealRow: { alignItems: "center", gap: 10, minHeight: 44 },
  dot: { width: 8, height: 8, borderRadius: 4 },
  dealTitle: { flex: 1, fontSize: 13, lineHeight: 21, fontFamily: "Inter_500Medium" },
  dealValue: { fontSize: 12, fontFamily: "Inter_600SemiBold" },
