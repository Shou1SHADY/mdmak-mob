...
const styles = StyleSheet.create({
  ...
  row: { borderRadius: 14, borderWidth: 1, padding: 14, marginBottom: 10, gap: 8 },
  rowTop: { alignItems: "center", gap: 8 },
  dot: { width: 8, height: 8, borderRadius: 4 },
  name: { flex: 1, fontSize: 15, lineHeight: 24, fontFamily: "Inter_600SemiBold" },
  ...
  meta: { flex: 1, fontSize: 12, fontFamily: "Inter_400Regular" },
  tier: { fontSize: 11, fontFamily: "Inter_600SemiBold" },
});
