...
const styles = StyleSheet.create({
  ...
  panelTitle: { fontSize: 15, lineHeight: 24, fontFamily: "Inter_600SemiBold", marginBottom: 12 },
  stageRow: { alignItems: "center", gap: 10, marginBottom: 10 },
  stageName: { width: 82, fontSize: 12, fontFamily: "Inter_400Regular" },
  barTrack: { flex: 1, height: 8, borderRadius: 4, overflow: "hidden" },
  barFill: { height: 8, borderRadius: 4, minWidth: 2 },
  stageCount: { width: 24, fontSize: 13, lineHeight: 21, fontFamily: "Inter_600SemiBold", textAlign: "center" },
  panelLink: {
    alignItems: "center",
  ...
  panelLinkText: { fontSize: 13, lineHeight: 21, fontFamily: "Inter_600SemiBold" },
  pillRow: { gap: 6 },
  ...
  taskText: { flex: 1, fontSize: 13, lineHeight: 21, fontFamily: "Inter_400Regular" },
  emptyLine: { fontSize: 13, lineHeight: 21, fontFamily: "Inter_400Regular", paddingVertical: 8 },
  bigLink: {
    alignItems: "center",
    gap: 12,
    borderRadius: 16,
