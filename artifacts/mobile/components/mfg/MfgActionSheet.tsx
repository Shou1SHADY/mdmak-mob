...
export function MfgActionSheet({
  ...
  const Check = ({ on, onToggle, label }: { on: boolean; onToggle: () => void; label: string }) => (
    <Pressable onPress={onToggle} style={[styles.check, { flexDirection: row, borderColor: colors.border }]}>
...
const styles = StyleSheet.create({
  overlay: { flex: 1, backgroundColor: "rgba(11,26,43,0.45)", justifyContent: "flex-end" },
  sheet: { borderTopLeftRadius: 20, borderTopRightRadius: 20, padding: 20, maxHeight: "90%", gap: 8 },
  handle: { width: 40, height: 4, borderRadius: 2 },
  title: { fontSize: 17, fontFamily: "Inter_600SemiBold" },
  subtitle: { fontSize: 13, fontFamily: "Inter_400Regular", marginBottom: 6 },
  hint: { fontSize: 12.5, fontFamily: "Inter_400Regular", marginBottom: 6, lineHeight: 19 },
  label: { fontSize: 12.5, fontFamily: "Inter_500Medium", marginTop: 8, marginBottom: 4 },
  ...
  checkText: { fontSize: 13.5, fontFamily: "Inter_400Regular" },
  line: { alignItems: "center", justifyContent: "space-between", gap: 10, borderWidth: 1, borderRadius: 10, padding: 12, marginBottom: 6 },
  lineName: { flex: 1, fontSize: 13.5, fontFamily: "Inter_500Medium" },
  lineQty: { fontSize: 13.5, fontFamily: "Inter_600SemiBold", fontVariant: ["tabular-nums"] },
});
