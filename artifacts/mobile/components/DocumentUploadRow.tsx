...
const styles = StyleSheet.create({
  ...
  docLabel: { fontSize: 14, lineHeight: 24, fontFamily: "Inter_600SemiBold" },
  docStatus: { fontSize: 12, lineHeight: 20, fontFamily: "Inter_400Regular" },
  ...
  modalTitle: { fontSize: 14, lineHeight: 24, fontFamily: "Inter_600SemiBold" },
  modalSub: { fontSize: 14, lineHeight: 24, fontFamily: "Inter_400Regular", marginTop: -6 },
  modalInput: {
    borderWidth: 1.5,
    borderRadius: 12,
  ...
  modalBtnText: { fontSize: 14, lineHeight: 24, fontFamily: "Inter_600SemiBold" },
});
