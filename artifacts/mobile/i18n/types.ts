export interface Translations {
  ...
  modules: {
    ...
    items: {
      ...
      sales_payments: string;
      sales_price_list: string;
      acc_dashboard: string;
      acc_locked: string;
      acc_income: string;
      acc_balance: string;
      acc_cashflow: string;
